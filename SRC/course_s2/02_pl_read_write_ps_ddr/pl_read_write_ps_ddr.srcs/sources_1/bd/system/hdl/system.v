...
(* CORE_GENERATION_INFO = "system,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=system,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=4,maxHierDepth=0,da_ps7_cnt=1,synth_mode=Global}" *) (* HW_HANDOFF = "system.hwdef" *) 
module system
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [5:0]axi_interconnect_1_M00_AXI1_ARID;
  wire [3:0]axi_interconnect_1_M00_AXI1_ARLEN;
  wire [1:0]axi_interconnect_1_M00_AXI1_ARLOCK;
  ...
  wire [63:0]axi_interconnect_1_M00_AXI1_RDATA;
  ...
  assign MM2S_AXI_arready = S00_AXI_2_ARREADY;
  assign MM2S_AXI_rdata[63:0] = S00_AXI_2_RDATA;
  assign MM2S_AXI_rid[5:0] = S00_AXI_2_RID;
  assign MM2S_AXI_rlast = S00_AXI_2_RLAST;
  assign MM2S_AXI_rresp[1:0] = S00_AXI_2_RRESP;
  assign MM2S_AXI_rvalid = S00_AXI_2_RVALID;
  assign S00_AXI_1_AWADDR = S2MM_AXI_awaddr[31:0];
  assign S00_AXI_1_AWBURST = S2MM_AXI_awburst[1:0];
  assign S00_AXI_1_AWCACHE = S2MM_AXI_awcache[3:0];
  assign S00_AXI_1_AWID = S2MM_AXI_awid[5:0];
  assign S00_AXI_1_AWLEN = S2MM_AXI_awlen[7:0];
  assign S00_AXI_1_AWLOCK = S2MM_AXI_awlock[0];
  assign S00_AXI_1_AWPROT = S2MM_AXI_awprot[2:0];
  assign S00_AXI_1_AWQOS = S2MM_AXI_awqos[3:0];
  assign S00_AXI_1_AWREGION = S2MM_AXI_awregion[3:0];
  assign S00_AXI_1_AWSIZE = S2MM_AXI_awsize[2:0];
  assign S00_AXI_1_AWVALID = S2MM_AXI_awvalid;
  assign S00_AXI_1_BREADY = S2MM_AXI_bready;
  assign S00_AXI_1_WDATA = S2MM_AXI_wdata[63:0];
  assign S00_AXI_1_WLAST = S2MM_AXI_wlast;
  assign S00_AXI_1_WSTRB = S2MM_AXI_wstrb[7:0];
  assign S00_AXI_1_WVALID = S2MM_AXI_wvalid;
  assign S00_AXI_2_ARADDR = MM2S_AXI_araddr[31:0];
  assign S00_AXI_2_ARBURST = MM2S_AXI_arburst[1:0];
  assign S00_AXI_2_ARCACHE = MM2S_AXI_arcache[3:0];
  assign S00_AXI_2_ARID = MM2S_AXI_arid[5:0];
  assign S00_AXI_2_ARLEN = MM2S_AXI_arlen[7:0];
  assign S00_AXI_2_ARLOCK = MM2S_AXI_arlock[0];
  assign S00_AXI_2_ARPROT = MM2S_AXI_arprot[2:0];
  assign S00_AXI_2_ARQOS = MM2S_AXI_arqos[3:0];
  assign S00_AXI_2_ARREGION = MM2S_AXI_arregion[3:0];
  assign S00_AXI_2_ARSIZE = MM2S_AXI_arsize[2:0];
  assign S00_AXI_2_ARVALID = MM2S_AXI_arvalid;
  assign S00_AXI_2_RREADY = MM2S_AXI_rready;
  assign S2MM_AXI_awready = S00_AXI_1_AWREADY;
  assign S2MM_AXI_bid[5:0] = S00_AXI_1_BID;
  assign S2MM_AXI_bresp[1:0] = S00_AXI_1_BRESP;
  assign S2MM_AXI_bvalid = S00_AXI_1_BVALID;
  assign S2MM_AXI_wready = S00_AXI_1_WREADY;
  assign clk_100m_1 = axi_hp_clk;
  system_axi_interconnect_1_0 axi_interconnect_0
       (.ACLK(clk_100m_1),
        .ARESETN(ARESETN_1),
        .M00_ACLK(clk_100m_1),
  ...
  system_axi_interconnect_2_0 axi_interconnect_1
       (.ACLK(clk_100m_1),
        .ARESETN(ARESETN_1),
        .M00_ACLK(clk_100m_1),
        .M00_ARESETN(proc_sys_reset_0_peripheral_aresetn),
  ...
  system_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr[14:0]),
        ...
        .S_AXI_HP1_ACLK(clk_100m_1),
        .S_AXI_HP1_ARADDR(axi_interconnect_1_M00_AXI1_ARADDR),
        .S_AXI_HP1_ARBURST(axi_interconnect_1_M00_AXI1_ARBURST),
        .S_AXI_HP1_ARCACHE(axi_interconnect_1_M00_AXI1_ARCACHE),
        .S_AXI_HP1_ARID(axi_interconnect_1_M00_AXI1_ARID),
        .S_AXI_HP1_ARLEN(axi_interconnect_1_M00_AXI1_ARLEN),
        .S_AXI_HP1_ARLOCK(axi_interconnect_1_M00_AXI1_ARLOCK),
        .S_AXI_HP1_ARPROT(axi_interconnect_1_M00_AXI1_ARPROT),
        .S_AXI_HP1_ARQOS(axi_interconnect_1_M00_AXI1_ARQOS),
        .S_AXI_HP1_ARREADY(axi_interconnect_1_M00_AXI1_ARREADY),
        .S_AXI_HP1_ARSIZE(axi_interconnect_1_M00_AXI1_ARSIZE),
        .S_AXI_HP1_ARVALID(axi_interconnect_1_M00_AXI1_ARVALID),
        ...
        .S_AXI_HP1_RDATA(axi_interconnect_1_M00_AXI1_RDATA),
        .S_AXI_HP1_RDISSUECAP1_EN(1'b0),
        .S_AXI_HP1_RID(axi_interconnect_1_M00_AXI1_RID),
        .S_AXI_HP1_RLAST(axi_interconnect_1_M00_AXI1_RLAST),
        .S_AXI_HP1_RREADY(axi_interconnect_1_M00_AXI1_RREADY),
        .S_AXI_HP1_RRESP(axi_interconnect_1_M00_AXI1_RRESP),
        .S_AXI_HP1_RVALID(axi_interconnect_1_M00_AXI1_RVALID),
