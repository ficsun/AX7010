...
#
# Generated by Vivado on Mon Sep 26 13:33:38 +0800 2016
...
# Script info
echo -e "video_pll.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./video_pll.sh -help\" for more information)\n"
  exit 1
fi
...
compile()
{
  ...
  ncvlog -work xil_defaultlib $opts_ver \
    "$ref_dir/../../../../HDMI_output_test.srcs/sources_1/ip/video_pll/video_pll_clk_wiz.v" \
    "$ref_dir/../../../../HDMI_output_test.srcs/sources_1/ip/video_pll/video_pll.v" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.video_pll xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.video_pll -input simulate.do
}
# Script usage
usage()
{
