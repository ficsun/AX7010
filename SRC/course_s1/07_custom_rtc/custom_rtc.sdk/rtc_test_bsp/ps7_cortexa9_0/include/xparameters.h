...
/* Definitions for driver RTC_IP */
#define XPAR_RTC_IP_NUM_INSTANCES 1

/* Definitions for peripheral RTC_IP_0 */
#define XPAR_RTC_IP_0_DEVICE_ID 0
#define XPAR_RTC_IP_0_S00_AXI_BASEADDR 0xFFFFFFFF
#define XPAR_RTC_IP_0_S00_AXI_HIGHADDR 0x00000000
