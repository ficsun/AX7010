...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI] [get_bd_intf_pins rtc_ip_0/S00_AXI]

  # Create port connections
  connect_bd_net -net Net [get_bd_ports DS1302_SIO] [get_bd_pins rtc_ip_0/DS1302_SIO]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_50M/slowest_sync_clk] [get_bd_pins rtc_ip_0/s00_axi_aclk]
  ...
  connect_bd_net -net rst_processing_system7_0_50M_peripheral_aresetn [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_50M/peripheral_aresetn] [get_bd_pins rtc_ip_0/s00_axi_aresetn]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs rtc_ip_0/S00_AXI/S00_AXI_reg] SEG_rtc_ip_0_S00_AXI_reg
...
preplace port DS1302_SCLK -pg 1 -y 330 -defaultsOSRD
preplace port DS1302_RST -pg 1 -y 310 -defaultsOSRD
preplace port DS1302_SIO -pg 1 -y 350 -defaultsOSRD
preplace inst rtc_ip_0 -pg 1 -lvl 3 -y 330 -defaultsOSRD
...
preplace netloc rst_processing_system7_0_50M_peripheral_aresetn 1 1 2 410 230 650
preplace netloc rtc_ip_0_DS1302_SCLK 1 3 1 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 260 NJ 260 NJ
preplace netloc Net 1 3 1 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 30 190 400 330 N
preplace netloc rtc_ip_0_DS1302_RST 1 3 1 NJ
levelinfo -pg 1 0 200 530 780 920 -top 0 -bot 400
",
}
